...
void hipewInit( int* resultDriver, int* resultRtc, uint32_t flags, const char** customPaths_Hip, const char** customPaths_Hiprtc )
{
	...
	const char* hip_paths[] = { "amdhip64_7.dll", "amdhip64_6.dll",
								"amdhip64.dll", // <- hip '5.x' DLL.
								NULL };
	const char* hiprtc_paths[] = {
		"hiprtc0701.dll", "hiprtc0605.dll", "hiprtc0604.dll", "hiprtc0603.dll", "hiprtc0602.dll", "hiprtc0601.dll", "hiprtc0600.dll", "hiprtc0507.dll", "hiprtc0506.dll", "hiprtc0505.dll", "hiprtc0504.dll", "hiprtc0503.dll", NULL };
	...
	const char* hip_paths[] = {
		...
		"/opt/rocm/hip/lib/libamdhip64.so", "/opt/rocm/lib/libamdhip64.so", "libamdhip64.so",
	...
	const char* hiprtc_paths[] = {
		...
		// .. if it doesn't exist, we take the generic symbolic link.
		"/opt/rocm/hip/lib/libhiprtc.so", "/opt/rocm/lib/libhiprtc.so", "libhiprtc.so", NULL };
